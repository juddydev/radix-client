...
export type IndexPageQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
  ...
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      materials?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'>
      >;
      maintenance?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'>
      >;
      country_of_origin?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'>
      >;
      ...
      media: {
        nodes: Array<
          | ({__typename: 'ExternalVideo'} & Pick<
              StorefrontAPI.ExternalVideo,
              'id' | 'alt' | 'embedUrl' | 'host' | 'mediaContentType'
            > & {
                previewImage?: StorefrontAPI.Maybe<
                  Pick<StorefrontAPI.Image, 'url'>
                >;
      ...
      seo: Pick<StorefrontAPI.Seo, 'description' | 'title'>;
      customMadeAccessories?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'> & {
      ...
      >;
      customMadeMaterial?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'> & {
          reference?: StorefrontAPI.Maybe<
            Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
              variants: {
      ...
      >;
      customMadeSole?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'> & {
          reference?: StorefrontAPI.Maybe<
            Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
              variants: {
